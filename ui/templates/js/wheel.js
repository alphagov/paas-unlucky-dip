...
d3.json(
  "{{ url_for('api_get_incident_set', incident_set_id=incident_set_id) }}",
  function (error, data) {
      ...
      vis
        ...
        .each("end", function () {
          ...
          if (data[picked].inkstory != undefined) {
            //populate incident
            d3.select("#incident p").html(
              '<h4 class="f4 center mw6">' +
                data[picked].title +
                "</h4>" +
                '<div id="play-area"> <ol id ="choices"><ol></div>'
            );
            container.on(
              "click",
              spin,
              ...
              stopwatch.start(),
              changeControls(),
              loadStory(data[picked].inkstory)
            );
          } else {
            //populate incident
            d3.select("#incident p").html(
